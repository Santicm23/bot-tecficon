...
def login_allianz(driver: webdriver.Chrome) -> None:
    try:
        ...
        driver.find_element(By.ID, "nx-input-0").send_keys(environment.USER_ALLIANZ)
        driver.find_element(By.ID, "nx-input-1").click()
        driver.find_element(By.ID, "nx-input-1").send_keys(environment.PASS_ALLIANZ)
        driver.find_element(By.CSS_SELECTOR, ".nx-button__content-wrapper").click()
        time.sleep(5)

        # Entrar a página de siniestros
        element = driver.find_element(By.CSS_SELECTOR, ".c-main-navbar__link")
